...
const styles = StyleSheet.create({
  ...
  statusCountBadge: {
    ...
    top: -2,
    left: -2,
    minWidth: SCREEN_WIDTH < 360 ? 20 : 22,
  ...
  statusCountText: {
    fontSize: SCREEN_WIDTH < 360 ? 9 : 10,
    color: COLORS.white,
    fontWeight: 'bold',
  },
  addMoreStatusButton: {
    ...
    bottom: -2,
    right: -2,
    width: SCREEN_WIDTH < 360 ? 22 : 24,
    height: SCREEN_WIDTH < 360 ? 22 : 24,
    borderRadius: SCREEN_WIDTH < 360 ? 11 : 12,
    justifyContent: 'center',
    alignItems: 'center',
    borderWidth: 2.5,
    borderColor: COLORS.background,
